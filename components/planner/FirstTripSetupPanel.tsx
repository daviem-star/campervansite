...
export default function FirstTripSetupPanel({
  ...
  return (
    <div className="mx-auto max-w-3xl rounded-[2rem] border border-slate-200 bg-white p-8 shadow-sm">
      <span className="planner-eyebrow inline-flex rounded-full border border-amber-200 bg-amber-50 px-3 py-1 text-amber-700">
        First Trip Setup
      </span>
      <h1 className="planner-title-hero mt-5 text-slate-950">Choose how this account should start.</h1>
      ...
      <div className="mt-8 grid gap-4 lg:grid-cols-2">
        <section className="rounded-3xl border border-slate-200 bg-slate-50 p-5">
          <p className="planner-title-lg text-slate-950">Import local trip</p>
        ...
        <section className="rounded-3xl border border-slate-200 bg-slate-50 p-5">
          <p className="planner-title-lg text-slate-950">Start with example trip</p>
          <p className="planner-copy mt-3 text-slate-600">
