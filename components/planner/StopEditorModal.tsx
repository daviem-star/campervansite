...
export default function StopEditorModal({
  ...
  return (
    <div className="planner-overlay fixed inset-0 z-50 flex items-center justify-center px-4 py-8">
      <div className="max-h-[92vh] w-full max-w-2xl overflow-y-auto rounded-2xl border border-app-border bg-app-surface p-5 shadow-2xl">
        <div className="mb-4 flex items-center justify-between">
          <h3 className="planner-title-lg text-app-text">{dialogTitle}</h3>
          <button
            type="button"
            onClick={onClose}
            className="planner-button-secondary rounded-lg border px-3 py-1 text-sm transition"
          >
            Close
          </button>
        </div>
        ...
        <form onSubmit={onSubmit} className="space-y-4">
          ...
          {type === "stay" ? (
            <div className="space-y-3 rounded-xl border border-brand-support/30 bg-brand-support/12 p-4">
              <StopSearchInput
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                <label className="flex items-center gap-2 rounded-xl border border-app-border bg-app-surface px-3 py-2 text-sm text-app-text">
                  <input
                    ...
                    className="h-4 w-4 rounded border-app-border accent-brand-primary focus:ring-brand-primary/20"
                  />
                  Electric hookup
                </label>
                <label className="flex items-center gap-2 rounded-xl border border-app-border bg-app-surface px-3 py-2 text-sm text-app-text">
          ...
          {type === "ferry" ? (
            <div className="space-y-3 rounded-xl border border-state-info-border bg-state-info-surface/75 p-4">
              <div className="grid gap-3 sm:grid-cols-2">
                <StopSearchInput
              ...
              <div>
                <div className="mb-1 flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="text-xs font-semibold text-state-info"
                  >
                    Use default -45m
                  </button>
                </div>
          ...
          {type === "point_of_interest" ? (
            <div className="space-y-3 rounded-xl border border-brand-secondary/30 bg-brand-secondary/10 p-4">
              <StopSearchInput
                label="POI location"
          ...
          {error ? <p className="tone-error rounded-xl border px-4 py-3 text-sm font-medium">{error}</p> : null}

          <div className="flex items-center justify-end gap-2">
            <button
              type="button"
              onClick={onClose}
              className="planner-button-secondary rounded-xl border px-4 py-2 text-sm font-semibold transition"
            >
              Cancel
            </button>
            <button
